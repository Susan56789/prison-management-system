...
<input type="text" name="Nid" size='8' maxlength='8' required placeholder="XX111100"  />



<tr >
<td bgcolor="#FFFFFF"><b>Full Name:</b>
<input type="text" name="Fname" required placeholder="Alexandia James" /></td>
</tr>
<br/>
   <tr><td><label for="on"><b>Date of Birth:</b></label>
               ...
               <option selected="selected" value="01">1995</option>
...
<br/>
<tr><td><label for="on"><b>Date In:</b></label>
               ...
               <td>
                       <input type="text" id="dday" name="dday"  value="DD" class="reg_fields"/>
                   </td>
                   <td>
                       <input type="text" id="dyear" name="dyear"  value="YYYY" class="reg_fields"/>
                   </td>
               </td>
</tr>
...
<tr>
<td bgcolor="#FFFFFF"><b>Sentence:</b>
<input type="text" name="sentence"  maxlength='7' required placeholder="2 Years" />
</td>
</tr>
<br/>
