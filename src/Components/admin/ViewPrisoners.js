	...
	<table align='center' border='0' bgcolor='green' width='1000' cellpadding='8' cellspacing='0' height='200'>
          <tr>
            <td bgcolor='#999999' valign='center'>
                ...
                <table align='center' width='100%' border='0' cellpadding='3' cellspacing='2' bgcolor='green'>
...
<td ><b><a href="deleteprisoners.php?id=' . $row['id'] . '">Delete</a></b></td>
</tr>
</table>
</tr>
...
<br/>	
          <tr>
			<td align="center"><a href="./Admin" target="_parent">Panel Admin</a>
            <b>|</b>
